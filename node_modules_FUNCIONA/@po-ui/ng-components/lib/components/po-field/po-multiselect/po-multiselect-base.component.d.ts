...
export declare abstract class PoMultiselectBaseComponent implements ControlValueAccessor, OnInit, Validator {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoMultiselectBaseComponent, never, never, { "autoFocus": "p-auto-focus"; "label": "p-label"; "help": "p-help"; "optional": "p-optional"; "placeholder": "p-placeholder"; "placeholderSearch": "p-placeholder-search"; "name": "name"; "hideSelectAll": "p-hide-select-all"; "filterService": "p-filter-service"; "autoHeight": "p-auto-height"; "debounceTime": "p-debounce-time"; "literals": "p-literals"; "required": "p-required"; "showRequired": "p-show-required"; "disabled": "p-disabled"; "hideSearch": "p-hide-search"; "options": "p-options"; "sort": "p-sort"; "filterMode": "p-filter-mode"; "fieldLabel": "p-field-label"; "fieldValue": "p-field-value"; }, { "change": "p-change"; }, never, never, false>;
}
