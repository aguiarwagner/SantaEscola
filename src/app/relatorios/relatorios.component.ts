...
import { PoBreadcrumb, PoChartOptions, PoChartSerie, PoChartType, PoDisclaimer, PoDisclaimerGroup, PoModalComponent, PoNotificationService, PoPageAction, PoPageFilter, PoSelectOption, PoTableColumn } from '@po-ui/ng-components';
...
export class RelatoriosComponent implements OnInit {
  ...
  Buscar(){
    ...
    this.isLoading = true;
    debugger
    this.httpService.getRelatorios(1, this.dataIni.toString(), this.dataFim.toString(), this.mapa.comunCongregacao).subscribe(dados => {
      this.itens = [];
      this.itens = dados
  ...
  async getEntradaSaida6Meses(){
    this.httpService.getRelatorios(2, this.dataIni.toString(), this.dataFim.toString(), this.mapa.comunCongregacao).subscribe(async dados => {
      this.itens4 = [];
      this.itens4 = dados
