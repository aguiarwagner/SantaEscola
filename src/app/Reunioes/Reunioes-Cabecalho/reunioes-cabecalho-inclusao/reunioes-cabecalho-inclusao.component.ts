...
import { PoComboFilterMode, PoNotificationService, PoSelectOption } from '@po-ui/ng-components';
...
export class ReunioesCabecalhoInclusaoComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    switch(dadosUser.name){
      case 'ccbitapevi':
        this.mapa.igreja = 'Jd. Itapevi - Central'
        break;
      case 'ccbadmitapevi':
        this.mapa.igreja = 'Jd. Itapevi - Central'
        break;
      case 'ccbengcardoso':
        this.mapa.igreja = 'Vila Engº Cardoso'
        break;
      case 'ccbnovaitapevi':
        this.mapa.igreja = 'Nova Itapevi'
        break;
    }
  }
