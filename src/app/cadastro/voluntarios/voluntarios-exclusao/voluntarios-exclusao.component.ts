...
@Component({
  selector: 'app-voluntarios-exclusao',
  templateUrl: './voluntarios-exclusao.component.html',
  styleUrls: ['./voluntarios-exclusao.component.css']
})
export class VoluntariosExclusaoComponent implements OnInit {
  mapa: Mapa = new Mapa();
  items: Array<any>;
  itens: any = [];
  id: any = "";
  ...
  Grava(){
      ...
      this.httpService.deleteVoluntarios(this.id, this.mapa).subscribe(() => {
        this.lOk = true;
        this.router.navigate(["/voluntarios"]);
