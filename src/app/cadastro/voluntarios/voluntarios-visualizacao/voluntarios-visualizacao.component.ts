...
@Component({
  selector: 'app-voluntarios-visualizacao',
  templateUrl: './voluntarios-visualizacao.component.html',
  styleUrls: ['./voluntarios-visualizacao.component.css']
})
export class VoluntariosVisualizacaoComponent implements OnInit {
  mapa: Mapa = new Mapa();
  items: Array<any>;
  itens: any = [];
  id: any = "";
