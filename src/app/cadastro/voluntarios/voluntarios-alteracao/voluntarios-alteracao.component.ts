...
@Component({
  selector: 'app-voluntarios-alteracao',
  templateUrl: './voluntarios-alteracao.component.html',
  styleUrls: ['./voluntarios-alteracao.component.css']
})
export class VoluntariosAlteracaoComponent implements OnInit {
  mapa: Mapa = new Mapa();
  items: Array<any>;
  itens: any = [];
  id: any = "";
  ...
  GetVoluntarios(){
    ...
    this.httpService.getVoluntariosId(parseInt(this.id)).subscribe((mapa: Mapa) => {
      this.mapa = mapa;
    });
  }
  ...
  Grava(){
    ...
    */
    ...
    this.httpService.putVoluntarios(this.mapa.recno, this.mapa).subscribe(() => {
      this.lOk = true
