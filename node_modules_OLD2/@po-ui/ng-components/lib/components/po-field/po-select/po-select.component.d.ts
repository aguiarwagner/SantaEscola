import { ChangeDetectorRef, DoCheck, ElementRef, EventEmitter, IterableDiffers, OnChanges, Renderer2, SimpleChanges } from '@angular/core';
 ...
 */
export declare class PoSelectComponent extends PoFieldValidateModel<any> implements DoCheck, OnChanges {
