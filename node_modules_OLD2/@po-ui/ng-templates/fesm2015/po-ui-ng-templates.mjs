...
import { poLocaleDefault, poLocales, PoI18nPipe, PoFieldModule, PoModalModule, poLanguageDefault, PoDividerModule, PoModule, PoModalComponent, PoDynamicModule, PoPageModule, PoWidgetModule, PoButtonModule, PoGridModule, InputBoolean, PoDynamicFormComponent, PoDynamicFieldType, PoLanguageModule, PoTableColumnSortType, PoTableModule, PoStepperOrientation, PoInfoOrientation, PoStepperStatus, PoContainerModule, PoDialogModule, PoInfoModule, PoStepperModule } from '@po-ui/ng-components';
...
class PoPageDynamicEditComponent {
    ...
    set literals(value) {
        if (value instanceof Object && !(value instanceof Array)) {
            this._literals = Object.assign(Object.assign(Object.assign({}, poPageDynamicEditLiteralsDefault[poLocaleDefault]), poPageDynamicEditLiteralsDefault[this.language]), value);
        }
        else {
...
class PoPageDynamicTableComponent extends PoPageDynamicListBaseComponent {
    ...
    set quickSearchParam(value) {
        this._quickSearchParam = value !== null && value !== void 0 ? value : 'search';
    }
    ...
    loadData(params = {}) {
        var _a;
        const key = (_a = this.keys[0]) !== null && _a !== void 0 ? _a : 'id';
        if (!this.serviceApi) {
...
PoPageJobSchedulerComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: PoPageJobSchedulerComponent, selectors: [["po-page-job-scheduler"]], viewQuery: function PoPageJobSchedulerComponent_Query(rf, ctx) {
    ...
    }, dependencies: [i4.NgClass, i4.NgIf, i5.ɵNgNoValidate, i5.NgControlStatusGroup, i5.NgForm, i2.PoContainerComponent, i2.PoPageDefaultComponent, i2.PoStepperComponent, PoPageJobSchedulerExecutionComponent, PoPageJobSchedulerParametersComponent, PoPageJobSchedulerSummaryComponent], styles: ["po-container .po-container{overflow-y:unset}\n"], encapsulation: 2 });
(function () {
