 ...
 */
export declare class PoLabelComponent {
    private _disabled?;
    private _field?;
    /**
     * @optional
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoLabelComponent, "po-label", never, { "disabled": "p-disabled"; "field": "p-field"; "for": "p-for"; "label": "p-label"; "requirement": "p-requirement"; }, {}, never, never, false>;
}
